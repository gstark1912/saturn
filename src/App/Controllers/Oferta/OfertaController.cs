...
namespace App.Controllers.Demanda
{
    public class OfertaController : Controller
    {
        ...
        private void enviarMailHabilitacionToAdmin(ApplicationUser user)
        {
            ...
            var body = $"Se registro el usuario '{user.FirstName} {user.LastName}' de la empresa '{user.Company.CompanyName}'";
        ...
        private void enviarMailNewVendorToAdmin(ApplicationUser user)
        {
            ...
            var body = $"Se registro una nueva empresa: '{user.Company.CompanyName}'. Contacto de la empresa:'{user.FirstName} {user.LastName}'";
